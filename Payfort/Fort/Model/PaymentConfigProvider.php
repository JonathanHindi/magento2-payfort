        ...
        foreach ($this->methodCodes as $code) {
            if ($this->methods[$code]->isAvailable()) {
                ...
                if($code == \Payfort\Fort\Model\Method\Cc::CODE) {
                    ...
                    $integrationType = $this->methods[$code]->getConfigData('integration_type');
                    $config['payment']['payfortFort'][$code]['integrationType'] = $integrationType;
                    if($integrationType == \Payfort\Fort\Helper\Data::PAYFORT_FORT_INTEGRATION_TYPE_MERCAHNT_PAGE2) {
